	...
	<div class="flex flex-col">
		...
		<div class="flex flex-col p-4 space-y-2">
			...
			<div>
				...
				<strong>Total Rating:</strong> {entry.PlayInfo.AfterRating} (+{entry.PlayInfo.AfterRating-entry.PlayInfo.BeforeRating})<br>
				<strong>DX Rating:</strong> {entry.DxRatingGen3}<br>
